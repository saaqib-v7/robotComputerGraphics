...
#ifdef _DEBUG
    // If the program stopped here, then that means that some kind of OpenGL error occurred
    // 1. You can find the error in the console.
    // 2. You can find the OpenGL function, which caused the error, using the Call Stack.
    //     (the arrow is pointing to the line that is after the function that caused the error!).
    // 3. The program can be continued from here (green triangle - Continue / F5)
    //     or can be stopped (red square - Stop / Shift + F5).
